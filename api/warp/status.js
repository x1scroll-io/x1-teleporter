// api/warp/status.js — serverless proxy for the Warp transaction-status
// endpoint: {base}/transactions/{sig}?from={from}
//
...
export const createWarpStatusProxy = (deps = {}) =>
  createWarpProxy({ ...deps, kind: "status" });

export default createWarpStatusProxy().handler;
